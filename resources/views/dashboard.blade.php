...
@section('contenido')
    ...
    <div class="flex justify-center">
        ...
        <div class="w-full md:w-8/12 lg:6/12 flex flex-col items-center md:flex-row">
            ...
            <div class="8-12 lg:w-6/12 px-5 ">
                <img src="{{ $user->imagen ? asset('profiles'). '/'. $user->imagen : asset('img/usuario.svg')}}" alt="imagen-usuario">
            </div>
    ...
    <section class="container mx-auto mt-10">
        ...
        <p class="text-gray-600 uppercase text-sm text-center font-bold">El usuario no tiene Publicaciones</p>
        @endif
