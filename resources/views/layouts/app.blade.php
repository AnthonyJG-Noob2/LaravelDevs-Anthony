...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100">
        ...
        <footer class="text-center p-5 text-gray-500 font-bold uppercase mt-10">   
            DevStagram-(Devyogram es solo un cambio de nombre para diferenciar un poco) - Todos los derechos reservados (hecho en un curso de laravel)
            {{date('Y')}}
        </footer>


 <!-- Load Dropzone JS as an ES Module from CDN -->
